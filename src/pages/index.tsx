  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Ngo list - Revolutionizing NGO Management. An effortless way to manage members and track their yearly payments seamlessly."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594708767771-a7502209ff51?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxuZ298ZW58MHx8fHwxNjk1MzEzMTkyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@iatulp?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Atul Pandey`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Ngo list - Revolutionizing NGO Management. An effortless way to manage members and track their yearly payments seamlessly.`}
            </Text>
            <Box
